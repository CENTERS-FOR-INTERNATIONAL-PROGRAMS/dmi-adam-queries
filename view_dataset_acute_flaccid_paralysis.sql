...
SELECT 
    ...
    (((couchdb.doc -> 'DForms'::text) -> 'case_demographics'::text) -> 0 -> 'DFields'::text -> 'values'::text -> 'date_of_birth'::text ->> 'df_value')::DATE AS case_date_of_birth,
    (((couchdb.doc -> 'DForms'::text) -> 'case_demographics'::text) -> 0 -> 'DFields'::text -> 'values'::text -> 'age_years'::text ->> 'df_value')::INT AS case_age_years,
    (((couchdb.doc -> 'DForms'::text) -> 'case_demographics'::text) -> 0 -> 'DFields'::text -> 'values'::text -> 'age_months'::text ->> 'df_value')::INT AS case_age_months,
    ...
    (((couchdb.doc -> 'DForms'::text) -> 'case_investigation_afp'::text) -> 0 -> 'DFields'::text -> 'values'::text -> 'date_of_onset'::text ->> 'df_value')::DATE AS case_paralysis_date_of_onset,
    ...
    (((couchdb.doc -> 'DForms'::text) -> 'vaccination_afp'::text) -> 0 -> 'DFields'::text -> 'values'::text -> 'total_vaccine_doses'::text ->> 'df_value')::INT AS total_vaccine_doses,
    (((couchdb.doc -> 'DForms'::text) -> 'vaccination_afp'::text) -> 0 -> 'DFields'::text -> 'values'::text -> 'date_of_opv_doses_at_birth'::text ->> 'df_value')::DATE AS date_of_opv_doses_at_birth,
    (((couchdb.doc -> 'DForms'::text) -> 'vaccination_afp'::text) -> 0 -> 'DFields'::text -> 'values'::text -> 'first_dose_date'::text ->> 'df_value')::DATE AS first_dose_date,
    (((couchdb.doc -> 'DForms'::text) -> 'vaccination_afp'::text) -> 0 -> 'DFields'::text -> 'values'::text -> 'second_dose_date'::text ->> 'df_value')::DATE AS second_dose_date,
    (((couchdb.doc -> 'DForms'::text) -> 'vaccination_afp'::text) -> 0 -> 'DFields'::text -> 'values'::text -> 'third_dose_date'::text ->> 'df_value')::DATE AS third_dose_date,
    (((couchdb.doc -> 'DForms'::text) -> 'vaccination_afp'::text) -> 0 -> 'DFields'::text -> 'values'::text -> 'fourth_dose_date'::text ->> 'df_value')::DATE AS fourth_dose_date,
    (((couchdb.doc -> 'DForms'::text) -> 'vaccination_afp'::text) -> 0 -> 'DFields'::text -> 'values'::text -> 'last_dose_date'::text ->> 'df_value')::DATE AS last_dose_date,
    (((couchdb.doc -> 'DForms'::text) -> 'vaccination_afp'::text) -> 0 -> 'DFields'::text -> 'values'::text -> 'last_opv_sia_dose'::text ->> 'df_value')::DATE AS last_opv_sia_dose,
    (((couchdb.doc -> 'DForms'::text) -> 'vaccination_afp'::text) -> 0 -> 'DFields'::text -> 'values'::text -> 'total_opv_sia_doses'::text ->> 'df_value')::INT AS total_opv_sia_doses,
    (((couchdb.doc -> 'DForms'::text) -> 'vaccination_afp'::text) -> 0 -> 'DFields'::text -> 'values'::text -> 'total_opv_ri_doses'::text ->> 'df_value')::INT AS total_opv_ri_doses,
    (((couchdb.doc -> 'DForms'::text) -> 'vaccination_afp'::text) -> 0 -> 'DFields'::text -> 'values'::text -> 'total_ipv_sia_doses'::text ->> 'df_value')::INT AS total_ipv_sia_doses,
    (((couchdb.doc -> 'DForms'::text) -> 'vaccination_afp'::text) -> 0 -> 'DFields'::text -> 'values'::text -> 'total_ipv_ri_doses'::text ->> 'df_value')::INT AS total_ipv_ri_doses,
    (((couchdb.doc -> 'DForms'::text) -> 'vaccination_afp'::text) -> 0 -> 'DFields'::text -> 'values'::text -> 'date_ipv_sia_ri'::text ->> 'df_value')::DATE AS date_ipv_sia_ri,
    ...
    (((couchdb.doc -> 'DForms'::text) -> 'specimen_results_afp'::text) -> 0 -> 'DFields'::text -> 'values'::text -> 'date_final_culture_result_available'::text ->> 'df_value')::DATE AS date_final_culture_result_available,
    (((couchdb.doc -> 'DForms'::text) -> 'specimen_results_afp'::text) -> 0 -> 'DFields'::text -> 'values'::text -> 'date_specimen_received_in_ic_lab'::text ->> 'df_value')::DATE AS date_specimen_received_in_ic_lab,
    ...
    (((couchdb.doc -> 'DForms'::text) -> 'specimen_results_afp'::text) -> 0 -> 'DFields'::text -> 'values'::text -> 'date_results_sent_to_national_epi'::text ->> 'df_value')::DATE AS date_results_sent_to_national_epi,
    (((couchdb.doc -> 'DForms'::text) -> 'specimen_results_afp'::text) -> 0 -> 'DFields'::text -> 'values'::text -> 'date_isolate_sent_by_national_laboratory_to_regional_laboratory'::text ->> 'df_value')::DATE AS date_isolate_sent_by_national_laboratory_to_regional_laboratory,
    (((couchdb.doc -> 'DForms'::text) -> 'specimen_results_afp'::text) -> 0 -> 'DFields'::text -> 'values'::text -> 'date_itd_results_sent_by_regional_laboratory'::text ->> 'df_value')::DATE AS date_itd_results_sent_by_regional_laboratory,
    (((couchdb.doc -> 'DForms'::text) -> 'specimen_results_afp'::text) -> 0 -> 'DFields'::text -> 'values'::text -> 'date_itd_results_received_by_county'::text ->> 'df_value')::DATE AS date_itd_results_received_by_county,
    (((couchdb.doc -> 'DForms'::text) -> 'specimen_results_afp'::text) -> 0 -> 'DFields'::text -> 'values'::text -> 'date_isolate_sent_for_sequencing'::text ->> 'df_value')::DATE AS date_isolate_sent_for_sequencing,
    (((couchdb.doc -> 'DForms'::text) -> 'specimen_results_afp'::text) -> 0 -> 'DFields'::text -> 'values'::text -> 'date_final_results_sent_to_epi'::text ->> 'df_value')::DATE AS date_final_results_sent_to_epi,
    ...
    (((couchdb.doc -> 'DForms'::text) -> 'specimen_collection_afp'::text) -> 0 -> 'DFields'::text -> 'values'::text -> 'date_first_specimen_collected'::text ->> 'df_value')::DATE AS date_first_specimen_collected,
    (((couchdb.doc -> 'DForms'::text) -> 'specimen_collection_afp'::text) -> 0 -> 'DFields'::text -> 'values'::text -> 'date_second_specimen_collected'::text ->> 'df_value')::DATE AS date_second_specimen_collected,
    (((couchdb.doc -> 'DForms'::text) -> 'specimen_collection_afp'::text) -> 0 -> 'DFields'::text -> 'values'::text -> 'date_specimen_sent_to_national'::text ->> 'df_value')::DATE AS date_specimen_sent_to_national,
    (((couchdb.doc -> 'DForms'::text) -> 'specimen_collection_afp'::text) -> 0 -> 'DFields'::text -> 'values'::text -> 'date_specimen_received_at_national'::text ->> 'df_value')::DATE AS date_specimen_received_at_national,
    (((couchdb.doc -> 'DForms'::text) -> 'specimen_collection_afp'::text) -> 0 -> 'DFields'::text -> 'values'::text -> 'date_specimen_sent_to_lab'::text ->> 'df_value')::DATE AS date_specimen_sent_to_lab,
    ...
    (((couchdb.doc -> 'DForms'::text) -> 'patient_movements_afp'::text) -> 0 -> 'DFields'::text -> 'values'::text -> 'duration_months'::text ->> 'df_value')::INT AS patient_movement_duration_months,
    (((couchdb.doc -> 'DForms'::text) -> 'patient_movements_afp'::text) -> 0 -> 'DFields'::text -> 'values'::text -> 'duration_days'::text ->> 'df_value')::INT AS patient_movement_duration_days,
    ((couchdb.doc -> 'DFields'::text) -> 'values'::text -> 'date_of_investigation'::text ->> 'df_value')::DATE AS case_investigation_date,
    ...
    ((couchdb.doc -> 'location'::text) ->> 'accuracy')::INT AS location_accuracy,
