...
SELECT 
    ...
    ((doc -> 'DForms'::text) -> 'case_demographics'::text) -> 0 -> 'DFields'::text -> 'values'::text -> 'age_months'::text -> 'df_value'::text::INT AS case_age_months,
    ((doc -> 'DForms'::text) -> 'case_demographics'::text) -> 0 -> 'DFields'::text -> 'values'::text -> 'age_years'::text -> 'df_value'::text::INT AS case_age_years,
    ...
    ((((((doc -> 'DForms'::text) -> 'case_investigation_nnt'::text) -> 0) -> 'DFields'::text) -> 'values'::text) -> 'baby_age_days'::text) -> 'df_value'::text::integer AS baby_age_days,
    ...
    (doc -> 'location' ->> 'accuracy')::int AS location_accuracy,
