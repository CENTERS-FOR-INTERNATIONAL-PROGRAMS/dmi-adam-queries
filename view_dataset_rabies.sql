...
SELECT 
    ...
    ((((((doc -> 'DForms'::text) -> 'case_respondent'::text) -> 0) -> 'DFields'::text) -> 'values'::text) -> 'respondent'::text) ->> 'df_value' AS respondent,
    ((((((doc -> 'DForms'::text) -> 'case_respondent'::text) -> 0) -> 'DFields'::text) -> 'values'::text) -> 'family'::text) ->> 'df_value' AS respondent_family_name,
    ((((((doc -> 'DForms'::text) -> 'case_respondent'::text) -> 0) -> 'DFields'::text) -> 'values'::text) -> 'given_name'::text) ->> 'df_value' AS respondent_given_name,
    ((((((doc -> 'DForms'::text) -> 'case_respondent'::text) -> 0) -> 'DFields'::text) -> 'values'::text) -> 'phone_number'::text) ->> 'df_value' AS respondent_phone_number,
    ((((((doc -> 'DForms'::text) -> 'case_respondent'::text) -> 0) -> 'DFields'::text) -> 'values'::text) -> 'address'::text) ->> 'df_value' AS respondent_address,
    ((((((doc -> 'DForms'::text) -> 'case_respondent'::text) -> 0) -> 'DFields'::text) -> 'values'::text) -> 'relationship'::text) ->> 'df_value' AS respondent_relationship,
    ((((((doc -> 'DForms'::text) -> 'case_respondent'::text) -> 0) -> 'DFields'::text) -> 'values'::text) -> 'relationship_other'::text) ->> 'df_value' AS respondent_relationship_other,
    ...
    ((((((doc -> 'DForms'::text) -> 'case_vaccination'::text) -> 0) -> 'DFields'::text) -> 'values'::text) -> 'vaccination_date'::text) ->> 'df_value'::date AS vaccination_date,
    ...
    ((((((doc -> 'DForms'::text) -> 'case_demographics'::text) -> 0) -> 'DFields'::text) -> 'values'::text) -> 'date_of_birth'::text) ->> 'df_value'::date AS date_of_birth,
    ...
    ((((((doc -> 'DForms'::text) -> 'case_exposure_rabies'::text) -> 0) -> 'DFields'::text) -> 'values'::text) -> 'exposure_date'::text) ->> 'df_value'::date AS exposure_date,
    ...
    ((((((doc -> 'DForms'::text) -> 'case_hospitalization'::text) -> 0) -> 'DFields'::text) -> 'values'::text) -> 'admission_date'::text) ->> 'df_value'::date AS admission_date,
    ((((((doc -> 'DForms'::text) -> 'case_hospitalization'::text) -> 0) -> 'DFields'::text) -> 'values'::text) -> 'inpatient_number'::text) ->> 'df_value' AS inpatient_number,
    ((((((doc -> 'DForms'::text) -> 'case_hospitalization'::text) -> 0) -> 'DFields'::text) -> 'values'::text) -> 'discharge_date'::text) ->> 'df_value'::date AS discharge_date,
    ...
    (doc -> 'DFields' -> 'values' -> 'date_of_investigation') ->> 'df_value'::date AS case_investigation_date,
    doc ->> 'fform_id' AS fform_id,
    (doc -> 'location' ->> 'accuracy')::double precision AS location_accuracy,
